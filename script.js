...
function checkCookieConsent() {
    const consent = localStorage.getItem('rs_cookie_consent');
    if (!consent) {
        setTimeout(() => {
...
function acceptCookies() {
    localStorage.setItem('rs_cookie_consent', 'accepted');
    document.getElementById('cookie-consent').style.display = 'none';
}

function declineCookies() {
    localStorage.setItem('rs_cookie_consent', 'declined');
    document.getElementById('cookie-consent').style.display = 'none';
}
...
window.addEventListener('DOMContentLoaded', () => {
    const savedLang = localStorage.getItem('rs_language') || 'en';
...
const partnerDetails = {
    ...
    "Avinash Madhur Official": {
        ...
        contact: "+9839233977 | Contact@rsfilmsgroup.in",
        managedBy: "R.S Films Group",
        type: "Artist",
        typeClass: "artist",
    ...
    "Gudiya Jhaki Official": {
        ...
        contact: "Contact@rsfilmsgroup.in | +91 91615 29116",
        managedBy: "R.S Films Group",
        type: "Devotional",
        typeClass: "devotional",
    ...
    "Ishu Tilakdhari Official": {
        ...
        contact: "6386505230, 8604287605 | Contact@rsfilmsgroup.in",
        managedBy: "R.S Films Group",
        type: "Devotional",
        typeClass: "devotional",
    ...
    "Lovkush Arpita Official": {
        ...
        contact: "+91 91405 69766 | Contact@rsfilmsgroup.in",
        managedBy: "R.S Films Group",
        type: "Devotional",
        typeClass: "devotional",
    ...
    "Mayur Bharat Raas": {
        ...
        contact: "+91 6394853086 | Contact@rsfilmsgroup.in",
        managedBy: "R.S Films Group",
        type: "Devotional",
        typeClass: "devotional",
    ...
    "R.S Films Bhojpuri": {
        ...
        contact: "9792946666 | Contact@rsfilmsgroup.in",
        managedBy: "R.S Films Group",
        type: "Music",
        typeClass: "music",
    ...
    "Siddhi Vinayak Films": {
        ...
        contact: "7068636112 | Contact@rsfilmsgroup.in",
        managedBy: "R.S Films Group",
        type: "Music",
        typeClass: "music",
